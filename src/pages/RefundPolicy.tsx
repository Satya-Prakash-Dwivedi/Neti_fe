    ...
    <div className="bg-slate-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-6 py-20 md:py-32">
        <header className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-lora font-bold text-slate-900 mb-6">Refund & Cancellation Policy</h1>
        ...
        <div className="prose prose-slate max-w-none text-slate-700 leading-relaxed space-y-6">
          ...
          <p>
            For any queries regarding refunds, email us at <a href="mailto:admin@netiacademy.com" className="text-[var(--color-neti-accent)] font-bold hover:underline">admin@netiacademy.com</a>.
          </p>
        </div>
      </div>
    </div>
