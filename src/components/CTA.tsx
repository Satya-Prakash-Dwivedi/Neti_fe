    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="bg-slate-50 border border-slate-200 rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden group shadow-sm transition-all hover:shadow-md">
          ...
          <h2 className="text-3xl md:text-5xl font-lora font-bold text-slate-900 mb-8 relative z-10 leading-tight">
          ...
          <div className="flex justify-center relative z-10">
            <Link 
              to="/plan-b" 
              className="w-full sm:w-auto px-12 py-5 bg-[var(--color-neti-accent)] text-white font-bold rounded-2xl hover:bg-[var(--color-neti-accent)] transition-all shadow-xl shadow-[var(--color-neti-accent)]/10 active:scale-95 flex items-center gap-3 group/btn"
            >
